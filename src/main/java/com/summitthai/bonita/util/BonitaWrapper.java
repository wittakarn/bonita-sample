 ...
 */
package com.summitthai.bonita.util;
...
public class BonitaWrapper {
     ...
     * @param password
     * @param map
     * @throws BonitaException if an exception occurs when starting the process
     */
    public static void instantiateProcess(String user, String password, Map<String, Serializable> map) throws BonitaException {
        // login
     ...
     * @param pendingTasks the page content
     */
    private static List<HashMap<String, Object>> generateResponseTask(int page, List<HumanTaskInstance> pendingTasks, ProcessAPI processAPI) throws DataNotFoundException {
        ...
        for (HumanTaskInstance task : pendingTasks) {
            ...
            stb.append(", approvementStatus: ");
            stb.append(processAPI.getActivityDataInstance("approvementStatus", task.getId()).getValue());
            stb.append(", leaveId: ");
            stb.append(processAPI.getActivityDataInstance("leaveId", task.getId()).getValue());
            ...
            hashMapTask.put("leaveId", processAPI.getActivityDataInstance("leaveId", task.getId()).getValue());
            hashMapTask.put("approvementStatus", processAPI.getActivityDataInstance("approvementStatus", task.getId()).getValue());
     ...
     * @param password
     * @param taskId
     * @throws BonitaException if an exception occurs when executing the task
     ...
     *
     * @throws BonitaException if an exception occurs when creating the platform
     */
     ...
     * @param startIndex the index of the first element of the page
